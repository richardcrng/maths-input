...
function defaultKeystrokeHandler({ e, ctrlr, key, cursor }) {
  switch (key) {
...
function customKeystrokeHandler({ e, ctrlr, key, cursor }) {
  switch (key) {
    case 'MQ-Left': ctrlr.moveLeft(); break;
    case 'MQ-Right': ctrlr.moveRight(); break;
    case 'MQ-Up': ctrlr.moveUp(); break;
    case 'MQ-Down': ctrlr.moveDown(); break;
...
Node.open(function(_) {
  _.keystroke = function(key, e, ctrlr) {
    ...
    // defaultKeystrokeHandler({ e, ctrlr, key, cursor })
    const handled = customKeystrokeHandler({ e, ctrlr, key, cursor })
    if (!handled) return // To preserve original MathQuill behaviour
